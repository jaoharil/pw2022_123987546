...
<div class="row">
    <div class="col-md-12">
        ...
        <table class="table table-striped table-danger mt-3 ">
            <thead>
                <tr>
                    <th>NO.</th>
                    <th>FOTO</th>
...
ORDER BY nip DESC LIMIT $mulai, $batas")
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                    <tr class="cap">
                        ...
                        <td width="45"><img class="foto-thumbnail" src='foto/<?php echo $data['foto']; ?>' alt="Foto Guru">
                        </td>
                        ...
                        ?>
                            <td width="120" class="center">
                                <a title="Ubah" class="btn btn-outline-primary" href="?page=ubahg&nip=<?php echo $data['nip']; ?>"><i class="fas fa-edit"></i></a>
                                <a title="Hapus" class="btn btn-outline-danger" href="proses_hapus_guru.php?nip=<?php echo $data['nip']; ?>" onclick="return confirm('Anda yakin ingin menghapus guru <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
                            </td>
                        <?php
                        }
                        ?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-end">
                        ...
                        // jika halaman aktif > 1, maka button Sebelumnya = aktif
                            ...
                            <li class="page-item"><a class="page-link" href="?hal=<?php echo $page - 1 ?>">Sebelumnya</a>
                            </li>
                        <?php
                        } ?>
                        ...
                        <?php
                        for ($x = 1; $x <= $halaman; $x++) { ?>
                            <li class="page-item"><a class="page-link" href="?hal=<?php echo $x ?>"><?php echo $x ?></a>
                            </li>
                        <?php
                        } ?>
                        ...
                        // jika halaman aktif <= jumlah halaman, maka button Selanjutnya = aktif
                            ...
                            <li class="page-item"><a class="page-link" href="?hal=<?php echo $page + 1 ?>">Selanjutnya</a>
                            </li>
                        <?php
                        } ?>
                    </ul>
